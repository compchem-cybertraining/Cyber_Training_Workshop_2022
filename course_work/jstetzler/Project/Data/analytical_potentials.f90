...
MODULE analytical_potentials
  ...
  SUBROUTINE CO_potential(H,R,grad_H,R_crossing)
    ...
    !A       = 115.5224992474779_dp
    !rho     = -0.4257942428504258_dp
    a1      = 0.406636249219595_dp  
    b1      = -1.324492431267218_dp  
    c1      = 2.793371200730674_dp     
    d1      = 113.2254804773144_dp  
    a2      = 0.1013660391968287_dp  
    b2      = -1.493783834733460_dp  
    c2      = 3.540036402252261_dp 
    d2      = 112.9260863172730_dp   
    ...
    H(1,1)=(0.4066362492195953*exp(-2.648984862534436*R + 5.586742401461348) - &
            0.8132724984391906*exp(-1.324492431267218*R + 2.793371200730674) + &
            0.0058760499814 - 0.1013660391968287*exp(-2.98756766946692*R + &
            7.080072804504522) + 0.2027320783936574*exp(-1.49378383473346*R + &
            3.540036402252261))*cos(0.3742438382911488*R*(R - 10.18532986989168))**2 + &
            0.1013660391968287*exp(-2.98756766946692*R + 7.080072804504522) - &
            0.2027320783936574*exp(-1.49378383473346*R + 3.540036402252261) - &
            112.8247202780762 
    
    
    H(2,1)=(-0.4066362492195953*exp(-2.648984862534436*R + 5.586742401461348) + &
             0.8132724984391906*exp(-1.324492431267218*R + 2.793371200730674) - &
             0.0058760499813666 + 0.1013660391968287*exp(-2.98756766946692*R + &
             7.080072804504522) - 0.2027320783936574*exp(-1.49378383473346*R + &
             3.540036402252261))*cos(0.3742438382911488*R*(R - &
             10.18532986989168))*sin(0.3742438382911488*R*(R - 10.18532986989168)) 
    H(1,2)=(-0.4066362492195953*exp(-2.648984862534436*R + 5.586742401461348) + &
             0.8132724984391906*exp(-1.324492431267218*R + 2.793371200730674) - &
             0.0058760499813666 + 0.1013660391968287*exp(-2.98756766946692*R + &
             7.080072804504522) - 0.2027320783936574*exp(-1.49378383473346*R + &
             3.540036402252261))*cos(0.3742438382911488*R*(R - &
             10.18532986989168))*sin(0.3742438382911488*R*(R - 10.18532986989168))
    H(2,2)=(-0.4066362492195953*exp(-2.648984862534436*R + 5.586742401461348) + &
             0.8132724984391906*exp(-1.324492431267218*R + 2.793371200730674) - &
             0.0058760499814 + 0.1013660391968287*exp(-2.98756766946692*R + &
             7.080072804504522) - 0.2027320783936574*exp(-1.49378383473346*R + &
             3.540036402252261))*cos(0.3742438382911488*R*(R - 10.18532986989168))**2 + &
             0.4066362492195953*exp(-2.648984862534436*R + 5.586742401461348) - &
             0.8132724984391906*exp(-1.324492431267218*R + 2.793371200730674) - &
             112.8188442280948

    grad_H(1,1)=(-1.077173268740488*exp(-2.648984862534436*R + &
5.586742401461348) + 1.077173268740488*exp(-1.324492431267218*R + &
2.793371200730674) + 0.3028379014863620*exp(-2.98756766946692*R + &
7.080072804504522) - 0.3028379014863620*exp(-1.49378383473346*R + &
3.540036402252261))*cos(0.3742438382911488*R*(R - 10.18532986989168))**2 + &
((0.1517424623255688*R - 0.7727735170277644)*exp(-2.98756766946692*R + &
7.080072804504522) + (-0.3034849246511376*R + &
1.545547034055529)*exp(-1.49378383473346*R + 3.540036402252261) + &
(-0.6087244427850300*R + 3.100029624815766)*exp(-2.648984862534436*R + &
5.586742401461348) + (1.217448885570060*R - &
6.200059249631532)*exp(-1.324492431267218*R + 2.793371200730674) - &
0.0087963019961*R + 0.0447966187328)*sin(0.3742438382911488*R*(R - &
10.18532986989168))*cos(0.3742438382911488*R*(R - 10.18532986989168)) - &
0.3028379014863620*exp(-2.98756766946692*R + 7.080072804504522) + &
0.3028379014863620*exp(-1.49378383473346*R + 3.540036402252261) 
    grad_H(1,2)=-((-0.6087244427850300*R + &
3.100029624815766)*exp(-2.648984862534436*R + 5.586742401461348) + &
(1.217448885570060*R - 6.200059249631532)*exp(-1.324492431267218*R + &
2.793371200730674) + (0.1517424623255688*R - &
0.7727735170277644)*exp(-2.98756766946692*R + 7.080072804504522) + &
(-0.3034849246511376*R + 1.545547034055529)*exp(-1.49378383473346*R + &
3.540036402252261) + 0.0447966187328 - &
0.00879630199612*R)*cos(0.3742438382911488*R*(R - 10.18532986989168))**2 + &
(1.077173268740488*exp(-2.648984862534436*R + 5.586742401461348) - &
1.077173268740488*exp(-1.324492431267218*R + 2.793371200730674) - &
0.3028379014863620*exp(-2.98756766946692*R + 7.080072804504522) + &
0.3028379014863620*exp(-1.49378383473346*R + &
3.540036402252261))*sin(0.3742438382911488*R*(R - &
10.18532986989168))*cos(0.3742438382911488*R*(R - 10.18532986989168)) + &
(0.3043622213925150*R - 1.550014812407883)*exp(-2.648984862534436*R + &
5.586742401461348) + (-0.6087244427850300*R + &
3.100029624815766)*exp(-1.324492431267218*R + 2.793371200730674) + &
(0.3863867585138822 - 0.07587123116278442*R)*exp(-2.98756766946692*R + &
7.080072804504522) + (0.1517424623255688*R - &
0.7727735170277643)*exp(-1.49378383473346*R + 3.540036402252261) + &
0.00439815099806*R - 0.0223983093664
    grad_H(2,1)=-((-0.6087244427850300*R + &
3.100029624815766)*exp(-2.648984862534436*R + 5.586742401461348) + &
(1.217448885570060*R - 6.200059249631532)*exp(-1.324492431267218*R + &
2.793371200730674) + (0.1517424623255688*R - &
0.7727735170277644)*exp(-2.98756766946692*R + 7.080072804504522) + &
...
0.7727735170277643)*exp(-1.49378383473346*R + 3.540036402252261) + &
0.00439815099806*R - 0.0223983093664   
    grad_H(2,2)=(1.077173268740488*exp(-2.648984862534436*R + 5.586742401461348) &
- 1.077173268740488*exp(-1.324492431267218*R + 2.793371200730674) - &
0.3028379014863620*exp(-2.98756766946692*R + 7.080072804504522) + &
0.3028379014863620*exp(-1.49378383473346*R + &
3.540036402252261))*cos(0.3742438382911488*R*(R - 10.18532986989168))**2 + &
